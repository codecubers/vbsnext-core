'TODO: Compare this file with @vbsnext's core logic; there are few improvements to update
'ArrayUtil.contains returning invalid function
'PathUtil.AddBasePath method added
'Import() re-written to suite commented import (only to get file names; not to merge content)
...
Function ResolveImports(entryPoint)
    ...
    ResolveImports = arrUtil.toString(IncludedScripts)
End Function

'Wscript.Echo ResolveImports(".\src\modules\globals.bas")