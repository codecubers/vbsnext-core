...
// Wscript.Echo
arrVBStoJS.push(new Array('wscript.echo\\s*\\(([^\)\r\n]*)\\)', 'console.log($1)'));	// with parens
arrVBStoJS.push(new Array('wscript.echo\\s*([^\)\r\n]*)', 'console.log($1)'));	// w/no parens
...
var fsa = require('fs');
var strRet = fsa.readFileSync("C:\\Users\\nanda\\git\\xps.local.npm\\vbspm\\lib\\trash\\classes.vbs").toString()
// var strRet = "Wscript.Echo \"Hello World!\"";
